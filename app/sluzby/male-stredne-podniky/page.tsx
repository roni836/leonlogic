            ...
            <section className="mb-16 relative pb-20 pt-32 md:mb-32 md:pb-24 md:pt-52 dark:bg-primary">
                ...
                <div className="container relative">
                    <div>
                        ...
                        >
                            Digitálne riešenia pre malé a stredné podniky
                        </h1>
                ...
                <div className="container">
                    <div className="max-w-[500px]">
                        <h2 className="text-3xl md:text-[40px] md:leading-[54px] font-extrabold mt-5">
                            Prečo potrebujú MSP digitalizáciu?
                        </h2>
                        <p className="font-semibold text-gray dark:text-[#9199B5] mt-5">
                            Nájdite tím digitálnych expertov, na ktorých sa môžete spoľahnúť. Každý deň pomáhame malým a stredným podnikom rásť prostredníctvom moderných technológií.
                        </p>
                    </div>
                    <div className="grid sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-8 mt-12">
                        ...
                        <div className="py-5 px-[17px] dark:bg-[#9199B5]/[0.12] rounded-2xl" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <h3 className="text-[22px]/6 font-bold left-6 mt-5">Analýza procesov</h3>
                            <p className="text-lg mt-2.5 text-gray dark:text-[#9199B5]">
                                Zmapovanie existujúcich procesov a identifikácia možností automatizácie
                            </p>
                        </div>
                        ...
                        <div className="py-5 px-[17px] dark:bg-[#9199B5]/[0.12] rounded-2xl" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <h3 className="text-[22px]/6 font-bold left-6 mt-5">Implementácia CRM</h3>
                            <p className="text-lg mt-2.5 text-gray dark:text-[#9199B5]">
                                Zavedenie systému správy zákazníkov a projektového manažmentu
                            </p>
                        </div>
                        ...
                        <div className="py-5 px-[17px] dark:bg-[#9199B5]/[0.12] rounded-2xl" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <h3 className="text-[22px]/6 font-bold left-6 mt-5">Automatizácia pracovného toku</h3>
                            <p className="text-lg mt-2.5 text-gray dark:text-[#9199B5]">
                                Automatizácia faktúrovania, emailov a rutinných administratívnych úloh
                            </p>
                        </div>
                        ...
                        <div className="py-5 px-[17px] dark:bg-[#9199B5]/[0.12] rounded-2xl" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <h3 className="text-[22px]/6 font-bold left-6 mt-5">Školenie a podpora</h3>
                            <p className="text-lg mt-2.5 text-gray dark:text-[#9199B5]">
                                Kompletné zaškolenie tímu a kontinuálna technická podpora
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col lg:flex-row items-center 2xl:gap-44 gap-10">
                            <div className="lg:max-w-[563px]">
                                ...
                                <h2 className="mt-[30px] text-3xl font-extrabold md:text-[40px] md:leading-[54px]">
                                    Pomáhame MSP rásť s digitálnymi riešeniami
                                </h2>
                                <p className="font-semibold text-gray dark:text-[#9199B5] mt-5">
                                    Nájdite tím digitálnych expertov, na ktorých sa môžete spoľahnúť. Každý deň pomáhame malým a stredným podnikom rásť prostredníctvom moderných technológií.
                                </p>
                                <ul className="mt-7 md:mt-12 space-y-3 text-lg text-primary dark:text-white font-semibold">
                                    ...
                                    <li className="flex items-center gap-2.5">
                                        ...
                                        <p>Automatizácia rutinných úloh šetrí čas zamestnancov</p>
                                    </li>
                                    ...
                                    <li className="flex items-center gap-2.5">
                                        ...
                                        <p>Lepší prehľad o zákazníkoch a projektoch</p>
                                    </li>
                                    ...
                                    <li className="flex items-center gap-2.5">
                                        ...
                                        <p>Možnosť konkurovať väčším firmám</p>
                                    </li>
                                    ...
                                    <li className="flex items-center gap-2.5">
                                        ...
                                        <p>Zvýšenie efektivity pracovných procesov o 30-40%</p>
                                    </li>
                                    ...
                                    <li className="flex items-center gap-2.5">
                                        ...
                                        <p>Úspora nákladov a zníženie chybovosti</p>
                                    </li>
