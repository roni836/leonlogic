                ...
                <div className="container relative">
                    <div className="grid gap-5 lg:grid-cols-2">
                        <div>
                            ...
                            <div className="mb-16 w-full max-w-[350px]">
                                <form>
                            ...
                            <div className="grid max-w-[345px] grid-cols-3">
                                <div className="relative text-center">
                                    <p className="text-[26px] font-bold leading-none dark:text-white">
                                        <CountsUp isCounting end={100} duration={2} />+
                                    </p>

                                    <span className="mt-3 block text-sm font-semibold uppercase text-[#9199B5]">clients</span>
                                    <span className="absolute inset-y-0 my-auto h-7 w-0.5 bg-[#D3DAF0] dark:bg-[#9199B5]/[0.12] ltr:right-0 rtl:left-0"></span>
                                </div>
                                <div className="relative text-center">
                                    <p className="text-[26px] font-bold leading-none dark:text-white">
                                        <CountsUp isCounting end={30} duration={2} />
                                    </p>
                                    <span className="mt-3 block text-sm font-semibold uppercase text-[#9199B5]">Startup</span>
                                    <span className="absolute inset-y-0 my-auto h-7 w-0.5 bg-[#D3DAF0] dark:bg-[#9199B5]/[0.12] ltr:right-0 rtl:left-0"></span>
                                </div>
                                <div className="text-center">
                                    <p className="text-[26px] font-bold leading-none dark:text-white">
                                        <CountsUp isCounting end={40} duration={2} />
                                    </p>
                                    <span className="mt-3 block text-sm font-semibold uppercase text-[#9199B5]">product</span>
                                </div>
                            </div>
                        </div>
