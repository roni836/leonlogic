...
-- Now you need to manually create the admin user in Supabase Auth:
-- 1. Go to Authentication > Users
-- 2. Click "Add User"
-- 3. Email: leonlogic.com@gmail.com
-- 4. Password: BB13c0541c1@@@!
-- 5. After creating, run this query to get the user_id:
-- SELECT id FROM auth.users WHERE email = 'leonlogic.com@gmail.com';
-- 6. Then insert into admin_users table with the user_id you got 