      ...
      <div className="min-h-[600px]">
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
            <div className="bg-white rounded-xl p-4 text-center border-[3px] border-[#9199B5]/10 hover:border-[#22C55E] transition-all duration-300 hover:shadow-lg transform hover:scale-105">
          ...
          {seoData.technologyStack && seoData.technologyStack.length > 0 && (
            <div className="bg-white rounded-xl p-6 border-[3px] border-[#9199B5]/10 hover:border-[#22C55E] transition-all duration-300 hover:shadow-lg mb-8">
              <h3 className="text-lg font-semibold text-[#112C3C] mb-4 flex items-center">
